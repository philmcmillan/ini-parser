...
namespace IniFileParser.Tests.Unit
{
    ...
    public class IniParserRegexTest
    {
        ...
        public void TestCommentRegex()
        {
            ...
            Assert.That(strGoodTest1, Does.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
            Assert.That(strGoodTest2, Does.Not.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
            Assert.That(strGoodTest3, Does.Not.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
            Assert.That(strGoodTest4, Does.Not.Match(iniParser.Parser.Configuration.CommentRegex.ToString()));
        }
        ...
        public void TestSectionRegex()
        {
            ...
            Assert.That(strGoodTest1, Does.Match(iniParser.Parser.Configuration.SectionRegex.ToString()));
